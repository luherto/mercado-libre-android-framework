...
class HomePage < BasePage
  #Elementos para la barra de busqueda
  ...
  #Elemento para entrar a la sesion como invitado
  ...
  #Elementos para navegar por el apartado de filtros
  ...
  #Elementos para listar el nombre y precio del producto
  ...
  #Buscar por termino 'playstation 5'
  def search_for(term)
  ...
  #Seleccionar region en la pantalla de selecion de pais
  def country_selection
    scroll_to_text("México").click
  end

  #Seleccionar opcion de invitado en la pantalla de inicio de sesion
  def select_guest_option()
    wait_for(GUEST_SELECTOR)
    @driver.find_element(GUEST_SELECTOR).click
  end
  
  #Hacer click en 'filtros'
  def filter_click()
    wait_for(FILTER_LIST)
    @driver.find_element(FILTER_LIST).click
  end

  #Desplazarse hasta cierto campo de texto y hacer click
  ...
  #Navegar por el menu de filtros y aplicar filtros
  def open_sort_menu
